/**
 * @(#) MonitorBatteryConfig.java Created on 2009-2-19
 *
...
/**
 * The class <code>MonitorBatteryConfig</code>
 *
 * @author xushengyong
 * @version 1.0
 */
public class MonitorBatteryConfig extends MonitorConfig {
     ...
     */
    protected byte nMonitorPoint = MonitorBatteryConfig.MONITOR_POINT_OFF;
     
    /**
     * The constructor
     */
    public MonitorBatteryConfig() {
    }
    ...
    public int decode(byte[] byMsg, int start, int length) throws ToolException {
        ...
        if (offset >= length) {
            throw new ToolException(
                    "MonitorBatteryConfig decode error: no MonitorPoint in the record");
        }
    ...
    /**
     * Encodes the MonitorBatteryConfig object into a buffer
     * 
    ...
    /**
     * Formats the MonitorBatteryConfig object to a readable string
     * 
    ...
    public boolean verifyField(MsgField field) throws ToolException {
        ...
        if (field == null) {
            throw new ToolException(
                "Message verify error: the field 'MonitorBatteryConfig' is null");
        }

        if (!(field instanceof MonitorBatteryConfig)) {
            throw new ToolException(
                "Message verify error: the field is not a 'MonitorBatteryConfig' object");
        }

        MonitorBatteryConfig obj = (MonitorBatteryConfig)field;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MonitorBatteryConfig)) {
            return false;
        }
        
        MonitorBatteryConfig oMsgField = (MonitorBatteryConfig)obj;
