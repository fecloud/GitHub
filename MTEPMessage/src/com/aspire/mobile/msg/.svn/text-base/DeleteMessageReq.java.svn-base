/**
 * @(#) DeleteMessageReq.java Created on 2009-2-16
 *
...
/**
 * 
 * The class <code>DeleteMessageReq</code>
 *
 * @author Link Wang
 * @version 1.0
 */
public class DeleteMessageReq extends MobileMsgBase {
    ...
    public DeleteMessageReq() {
        super(MobileConstants.DELETE_MESSAGE_REQ, "DeleteMessageReq");
    }
    ...
    public boolean verify(MsgBase msgVerified) throws ToolException {
        ...
        if (!(msgVerified instanceof DeleteMessageReq)) {
            throw new ToolException(
                 "Message verify error: the message to be verified is not a 'DeleteMessageReq' message");
        }

        DeleteMessageReq obj = (DeleteMessageReq)msgVerified;
    ...
    public MsgBase createDefaultResponse() {
        DeleteMessageResp oResp = new DeleteMessageResp();
    ...
    public boolean equals(Object obj) {
        ...
        DeleteMessageReq oMsgObj = (DeleteMessageReq)obj;
