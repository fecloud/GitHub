...
private HttpRequestTransmitter reqTransmitter;
	...
	public ESScriptRequest(IScriptService service){
	...
	public void request(String testMode, String venderCode,
            ...
            IFTPClient ftpClient, IHTTPClient httpClient, String imei, String ftpLocalPath, String ftpPath, String separator){
		...
		ESScriptSearchHandler tmScriptSearchHandler = new ESScriptSearchHandler();
		...
		tmScriptSearchHandler.setService(service);
