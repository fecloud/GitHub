...
public class ApkCaseUtil implements ServiceConnection {
    ...
    private static final Intent INTENT = new Intent("com.aspire.android.test.execute.TestService");

    private boolean isConnection;

    private Context mContext;

    private static final int BINDSERVER_TIMEOUT = 2000;
    ...
    public ContentValues runCase(ContentValues params) throws MException {
        final ContentValues values = deviceEntity.executeCommand(CommandConstants.TYPE_RUNTEST, params);
        return values;
    }
    ...
    public boolean install(String apk_path) throws MException {
        ...
        throw new NullPointerException("the apk_path is null");
    }
    ...
    public boolean uninstall(String packageName) throws MException {
        ...
        throw new NullPointerException("the packageName is null");
    }
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        isConnection = true;
        final ITestService iTestService = ITestService.Stub.asInterface(service);
