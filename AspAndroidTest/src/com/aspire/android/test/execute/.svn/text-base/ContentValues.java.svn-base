/**
 * @(#) ContentValues.java Created on 2012-4-28
 *
...
/**
 * The class <code>ContentValues</code>
 *
 * @author linjunsui
 * @version 1.0
 */
...
public final class ContentValues implements Parcelable {
     ...
     */
    private ContentValues(HashMap<String, Object> values, List<TransactionData> datas) {
        mValues = values;
    ...
    /**
     * Adds a list value to the set
     * 
     * @param key
     * @param list
     */
    public void put(String key, List<?> list) {
        mValues.put(key, list);
    }
    ...
    public static final Parcelable.Creator<ContentValues> CREATOR = new Parcelable.Creator<ContentValues>() {
        ...
        public ContentValues createFromParcel(Parcel in) {
            ...
            List<TransactionData> datas = in.readArrayList(TransactionData.class.getClassLoader());
            return new ContentValues(values, datas);
        }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        parcel.writeList(transactionDatas);
    }
    ...
    /**
     * Getter of transactionDatas
     * 
     * @return the transactionDatas
     */
    ...
    /**
     * Setter of transactionDatas
     * 
     * @param transactionDatas
     *            the transactionDatas to set
     */
