...
/**
 * 
 * The class <code>KeyDownRequest</code>
 *
 * @author Fan Yang
 * @version 1.0
 */
public class KeyDownRequest extends APSMessage {
     ...
     * @param keys
     */
    public KeyDownRequest(short[] keys) {
        super(APSMessage.KD_REQ);
        this.keys = keys;
    }
	...
	protected void decodeBody(ByteBuffer source) throws ToolException {
        ...
        for(int i=0;i<(source.remaining()/2);i++){
