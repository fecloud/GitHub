...
public class GrabImageResponse extends CommonResponse {
     ...
     * 
     * (non-Javadoc)
     * @see com.inspurworld.msg.common.mcts.agent.msg.CommonResponse#encodeBody(java.nio.ByteBuffer)
     */
    @Override
     ...
     * 
     * (non-Javadoc)
     * @see com.inspurworld.msg.common.mcts.agent.msg.CommonResponse#decodeBody(java.nio.ByteBuffer)
     */
    @Override
