...
/**
 * 
 * The class <code>TouchDClickRequest</code>
 *
 * @author Fan Yang
 * @version 1.0
 */
public class TouchDClickRequest extends APSMessage {
     ...
     * Constructor
     */
    public TouchDClickRequest() {
        super(APSMessage.TDC_REQ);
    }
    /**
     * 
     * Constructor
     * @param XY
     */
    public TouchDClickRequest(int[] XY) {
        super(APSMessage.TDC_REQ);
        this.XY = XY;
    }
    /**
