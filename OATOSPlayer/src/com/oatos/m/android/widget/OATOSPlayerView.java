/**
 * @(#) VideoView.java Created on 2013-6-28
 *
...
/**
 * The class <code>VideoView</code>
 * 
 * @author Feng OuYang
 * @version 1.0
 */
public class OATOSPlayerView extends SurfaceView implements MediaPlayerControl {
	...
	public OATOSPlayerView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		this.mContext = context;
		initVideoView();
	}

	public OATOSPlayerView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void attachMediaController() {
		if (mMediaPlayer != null && mMediaController != null) {
			...
			// mMediaController.initControlView();
	...
	MediaPlayer.OnPreparedListener mPreparedListener = new MediaPlayer.OnPreparedListener() {
		public void onPrepared(MediaPlayer mp) {
			...
			if (mVideoWidth != 0 && mVideoHeight != 0) {
				...
				Log.d(TAG, "mVideoWidth=mVideoHeight=0");
				if (mTargetState == STATE_PLAYING) {
					start();
					if (mMediaController != null) {
						mMediaController.show();
