/**
 * @(#) TTResponseMessageListener.java Created on 2012-5-8
 *
...
/**
 * The class <code>TTResponseMessageListener</code>
 *
 * @author linjunsui
 * @version 1.0
 */
public class TTResponseMessageListener implements IAPSMessageListener {
