/**
 * @(#) LocalModifyDatagramPacket.java Created on 2013-8-8
 *
...
/**
 * The class <code>LocalModifyDatagramPacket</code>
 * 
 * @author Feng OuYang
 * @version 1.0
 */
public class LocalModifyDatagramPacket extends QQModityPacket {
	 ...
	 */
	public LocalModifyDatagramPacket(String srcServer, int scrServerPort, String targetServer,
