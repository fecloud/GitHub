...
public class OCRParam extends CheckParam {
     ...
     * @param lang
     */
    public OCRParam(String inputPath) {
        super(inputPath, 0, 0, 0, 0);
        final OCRParamLoader loader = OCRParamLoader.getInstance();
        final String str = loader.find(getActivityName());
        if (null != str) {
            final String[] strings = str.split("_");
            this.lang = Integer.parseInt(strings[0]);
            this.expect = strings[1];
        }

        // TODO　this.lang = lang;
        // TODO　this.expect = expect;
    }
     ...
     * @param lang
     */
    public OCRParam(String inputPath, int lang, String expect) {
        super(inputPath, 0, 0, 0, 0);
        this.lang = lang;
        this.expect = expect;
    }
     ...
     * @param lang
     */
    public OCRParam(String inputPath, int startX, int startY, int width, int height, int lang, String expect) {
     ...
     * @param threshold
     */
    public OCRParam(String inputPath, int startX, int startY, int width, int height, int lang, double scale,
    ...
    public String getFile() {
        return getInputPath().substring(getInputPath().lastIndexOf(File.separator) + 1);
    }
