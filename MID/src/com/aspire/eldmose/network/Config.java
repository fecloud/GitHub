...
public class Config {
	...
	// public static final int APN_SWITCH_TIMEOUT = 20 * 1000; // APN切换超时时间时间�?

	// public static final String URL_SERVICE =
	// "http://119.78.1.130:8080/client";// 业务支撑平台

	// public static final String URL_SERVICE_GSM_GOOGLE =
	// "http://www.google.com/loc/json";// 业务支撑平台

	// public static final int GPS_TIME_OUT = 1000 * 20;

	// public static final String CAMER_PIC_HEAD_PATH =
