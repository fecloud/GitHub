...
/**
 * 
 * The class <code>TouchMoveRequest</code>
 *
 * @author Fan Yang
 * @version 1.0
 */
public class TouchMoveRequest extends APSMessage {
     ...
     * Constructor
     */
    public TouchMoveRequest() {
        super(APSMessage.TM_REQ);
    }
    /**
     * 
     * Constructor
     * @param XY
     */
    public TouchMoveRequest(int[] XY) {
        super(APSMessage.TM_REQ);
        this.XY = XY;
    }
    /**
